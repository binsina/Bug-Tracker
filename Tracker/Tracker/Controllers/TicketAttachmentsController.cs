...
namespace Tracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,FilePath,Description,Created,UserId,FileUrl")] TicketAttachment ticketAttachment, HttpPostedFileBase attach)
        {
            ...
            if (ModelState.IsValid)
            {
                if (attach != null)
                {
                    ...
                    ticketAttachment.FileUrl = filePath + attach.FileName;
                    //save image
                    ticketAttachment.FilePath = Path.Combine(absPath, attach.FileName);
                    attach.SaveAs(ticketAttachment.FilePath);
                }
            ...
            ViewBag.TicketId = new SelectList(db.Tickets, "Id", "Description", ticketAttachment.TicketId);
            return View(ticketAttachment);
        }
