...
namespace Tracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,UserId,Details,DateNotified")] TicketNotification ticketNotification)
        {
            ...
            ViewBag.TicketId = new SelectList(db.Tickets, "Id", "Description", ticketNotification.TicketId);
            return View(ticketNotification);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,UserId,Details,DateNotified")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
